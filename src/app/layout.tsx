        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "name": "Samuel Oluwasegun Portfolio",
              "url": "https://www.samuel-oluwasegun.bio",
              "description": "Professional portfolio website showcasing web development projects, skills, and experience",
              "author": {
                "@type": "Person",
                "name": "Samuel Oluwasegun"
              },
              ...
              "potentialAction": {
                "@type": "SearchAction",
                "target": "https://www.samuel-oluwasegun.bio?search={search_term_string}",
