export const roleContent = {
  frontend: {
    ...
    aboutText:
      "I'm a frontend-focused software engineer with 3+ years of experience building user-centric web applications. I specialize in creating beautiful, accessible, and performant user interfaces using modern frontend technologies.",
    ...
    experience: [
      ...
      // },
      {
        ...
        type: 'Contract',
        description:
          'Delivered frontend solutions for e-commerce, fintech, and SaaS clients, building React applications with modern UI/UX patterns. Worked directly with stakeholders for design feedback and user acceptance testing.',
        achievements: [
          {
            icon: 'Award',
            text: 'Delivered frontend solutions for diverse clients',
            metric: 'Multi-industry',
          },
          {
            icon: 'TrendingUp',
            text: 'Improved UI performance by up to 25%',
            metric: '25% faster',
          },
          {
            icon: 'Users',
      ...
      },
      {
        ...
        type: 'Program',
        description:
          'Built a Next.js demo app with code splitting and caching that achieved a 95% Lighthouse performance score. Authored unit tests and configured GitHub Actions for live previews.',
        achievements: [
          {
            icon: 'Award',
  ...
  backend: {
    ...
    aboutText:
      "I'm a backend-focused software engineer with 3+ years of experience building robust, scalable server-side applications. I specialize in API design, database architecture, and system optimization.",
    ...
    experience: [
      {
        ...
        type: 'Full-time',
        description:
          'Built scalable backend services and APIs, implementing Redis caching and optimized database queries to slash average API response times by 35%.',
        achievements: [
          {
            icon: 'Zap',
      ...
      },
      {
        ...
        type: 'Full-time',
        description:
          'Designed Node.js matchmaking service supporting 2,000+ concurrent sessions with <1% error rate. Automated Docker builds and GitHub Actions workflows.',
        achievements: [
          {
            icon: 'Users',
      ...
      },
      {
        ...
        type: 'Contract',
        description:
          'Delivered backend solutions for e-commerce, fintech, and SaaS clients, building Node.js/Express APIs and designing optimized SQL and NoSQL schemas.',
        achievements: [
          {
            icon: 'Award',
            text: 'Delivered backend solutions for diverse clients',
            metric: 'Multi-industry',
          },
          {
            icon: 'TrendingUp',
      ...
      },
      {
        ...
        type: 'Program',
        description:
          'Built backend services with Next.js API routes and configured GitHub Actions for automated testing and deployment workflows.',
        achievements: [
          {
            icon: 'Award',
            text: 'Achieved 95% API performance score',
            metric: '95% score',
          },
          {
            icon: 'Check',
  ...
  fullstack: {
    ...
    heroSubtitle:
      'I build intelligent, scalable solutions at the intersection of AI and full-stack engineering.',
    aboutText:
      "I'm a full-stack engineer and AI automation specialist with 3+ years of experience. I bridge complex AI workflows with high-performance applications, building intelligent solutions that scale. Whether it's integrating LLMs, building n8n automation pipelines, or architecting secure, scalable systems, I focus on creating technology that works.",
